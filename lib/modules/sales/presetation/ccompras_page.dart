...
class CcomprasPage extends StatefulWidget {
  const CcomprasPage({super.key});
  @override
  State<CcomprasPage> createState() => _CcomprasPage();
}

class _CcomprasPage extends State<CcomprasPage> {
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            const Text('Facturas de Compras'),
          ],
        ),
