...
class ClconfiguracionPage extends StatefulWidget {
  const ClconfiguracionPage({super.key});
  @override
  State<ClconfiguracionPage> createState() => _ClconfiguracionPage();
}

class _ClconfiguracionPage extends State<ClconfiguracionPage> {
