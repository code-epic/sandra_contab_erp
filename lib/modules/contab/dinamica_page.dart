...
class DinamicaPage extends StatefulWidget {
  const DinamicaPage({super.key});
  @override
  State<DinamicaPage> createState() => _DinamicaPage();
}

class _DinamicaPage extends State<DinamicaPage> {
